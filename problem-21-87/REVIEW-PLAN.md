...
**Current stage:** Revision 2 in progress; revised candidate freeze pending.
**Generic protocol:**
...
| Revision 2 | in progress | Primitive, monolithic, and crown-based-power completeness | `reviews/02-revision.md`; freeze pending |
