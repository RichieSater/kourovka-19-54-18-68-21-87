...
ROOT_FILES = (
    ...
    "docs/SOLUTION-REVIEW-WORKFLOW.md",
    "docs/PROBLEM-REVIEW-OVERLAYS.md",
    "docs/DECISION-LOG.md",
    "tracker/README.md",
    "tracker/portfolio.json",
    "tracker/legacy-10-34.md",
    "tracker/legacy-19-57-19-58.md",
    "templates/INITIAL-SOLUTION.md",
    "templates/REVISION-ROUND.md",
    "templates/REFEREE-PASS.md",
